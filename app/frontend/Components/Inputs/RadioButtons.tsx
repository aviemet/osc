...
export interface RadioButtonsProps extends Omit<SegmentedControlProps, 'data'> {
	label?: string
...
const RadioButtons = ({ label, labelPosition = 'start', options, name, id, value, required, onChange }: RadioButtonsProps) => {
