...
RSpec.describe "/payloads", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Payload.create! valid_attributes
      get payloads_url
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Payload" do
        expect {
          post payloads_url, params: { payload: valid_attributes }
        }.to change(Payload, :count).by(1)
      end

      it "redirects to the created payload" do
        post payloads_url, params: { payload: valid_attributes }
        expect(response).to redirect_to(payload_url(Payload.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Payload" do
        expect {
          post payloads_url, params: { payload: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested payload" do
        payload = Payload.create! valid_attributes
        patch payload_url(payload), params: { payload: new_attributes }
        payload.reload
      ...
      it "redirects to the payload" do
        ...
        patch payload_url(payload), params: { payload: new_attributes }
        payload.reload
        expect(response).to redirect_to(payload_url(payload))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        payload = Payload.create! valid_attributes
        patch payload_url(payload), params: { payload: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
  ...
  describe "DELETE /destroy" do
    ...
    it "redirects to the payloads list" do
      payload = Payload.create! valid_attributes
      delete payload_url(payload)
      expect(response).to redirect_to(payloads_url)
    end
  end
end
